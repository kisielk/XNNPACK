  ...
  do {
    ...
    if (bh != 0) {
      ...
      if (bh & 4) {
        ...
        _mm_storeu_ps(o, _mm256_castps256_ps128(v0_7));
        float *oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 7) {
          o = oN;
        }
        _mm_storeu_ps(o, _mm256_castps256_ps128(v0_6));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 7) {
          o = oN;
        }
        _mm_storeu_ps(o, _mm256_castps256_ps128(v0_5));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 5) {
          o = oN;
        }
        _mm_storeu_ps(o, _mm256_castps256_ps128(v0_4));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 5) {
          o = oN;
        }
        _mm_storeu_ps(o, _mm256_castps256_ps128(v0_3));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 3) {
          o = oN;
        }
        _mm_storeu_ps(o, _mm256_castps256_ps128(v0_2));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 3) {
          o = oN;
        }
        _mm_storeu_ps(o, _mm256_castps256_ps128(v0_1));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 1) {
          o = oN;
        }
      ...
      if (bh & 2) {
        o = (float*) ((uintptr_t) o + oN_stride);
        _mm_storel_pd((double*) o, _mm_castps_pd(_mm256_castps256_ps128(v0_7)));
        float *oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 7) {
          o = oN;
        }
        _mm_storel_pd((double*) o, _mm_castps_pd(_mm256_castps256_ps128(v0_6)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 7) {
          o = oN;
        }
        _mm_storel_pd((double*) o, _mm_castps_pd(_mm256_castps256_ps128(v0_5)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 5) {
          o = oN;
        }
        _mm_storel_pd((double*) o, _mm_castps_pd(_mm256_castps256_ps128(v0_4)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 5) {
          o = oN;
        }
        _mm_storel_pd((double*) o, _mm_castps_pd(_mm256_castps256_ps128(v0_3)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 3) {
          o = oN;
        }
        _mm_storel_pd((double*) o, _mm_castps_pd(_mm256_castps256_ps128(v0_2)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 3) {
          o = oN;
        }
        _mm_storel_pd((double*) o, _mm_castps_pd(_mm256_castps256_ps128(v0_1)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 1) {
          o = oN;
        }
      ...
      if (bh & 1) {
        o = (float*) ((uintptr_t) o + oN_stride);
        unaligned_store_u32(o, _mm256_cvtsi256_si32(_mm256_castps_si256(v0_7)));
        float* oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 7) {
          o = oN;
        }
        unaligned_store_u32(o, _mm256_cvtsi256_si32(_mm256_castps_si256(v0_6)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 7) {
          o = oN;
        }
        unaligned_store_u32(o, _mm256_cvtsi256_si32(_mm256_castps_si256(v0_5)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 5) {
          o = oN;
        }
        unaligned_store_u32(o, _mm256_cvtsi256_si32(_mm256_castps_si256(v0_4)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 5) {
          o = oN;
        }
        unaligned_store_u32(o, _mm256_cvtsi256_si32(_mm256_castps_si256(v0_3)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 3) {
          o = oN;
        }
        unaligned_store_u32(o, _mm256_cvtsi256_si32(_mm256_castps_si256(v0_2)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 3) {
          o = oN;
        }
        unaligned_store_u32(o, _mm256_cvtsi256_si32(_mm256_castps_si256(v0_1)));
        oN = (float*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 1) {
          o = oN;
        }
