    ...
    const union xnn_x64_transpose_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    for (; bh >= 4; bh -= 4) {
      ...
      const __m256d v0_0 = _mm256_permute2f128_pd(v1_0, v1_2, 0x20);
      const __m256d v0_2 = _mm256_permute2f128_pd(v1_0, v1_2, 0x31);
      const __m256d v0_1 = _mm256_permute2f128_pd(v1_1, v1_3, 0x20);
    ...
    if (bh != 0) {
      ...
      if (bh & 2) {
        _mm_storeu_pd(o3, _mm256_castpd256_pd128(v0_3));
        o3 += 2;
        _mm_storeu_pd(o2, _mm256_castpd256_pd128(v0_2));
        o2 += 2;
        _mm_storeu_pd(o1, _mm256_castpd256_pd128(v0_1));
        o1 += 2;
        _mm_storeu_pd(o0, _mm256_castpd256_pd128(v0_0));
        o0 += 2;
      ...
      if (bh & 1) {
        _mm_storel_pd((double*) o3, (_mm256_castpd256_pd128(v0_3)));
        _mm_storel_pd((double*) o2, (_mm256_castpd256_pd128(v0_2)));
        _mm_storel_pd((double*) o1, (_mm256_castpd256_pd128(v0_1)));
        _mm_storel_pd((double*) o0, (_mm256_castpd256_pd128(v0_0)));
      }
    }
