  ...
  do {
    ...
    if (bh != 0) {
      ...
      if (bh & 2) {
        ...
        _mm_storeu_pd(o, _mm256_castpd256_pd128(v0_3));
        double *oN = (double*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 3) {
          o = oN;
        }
        _mm_storeu_pd(o, _mm256_castpd256_pd128(v0_2));
        oN = (double*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 3) {
          o = oN;
        }
        _mm_storeu_pd(o, _mm256_castpd256_pd128(v0_1));
        oN = (double*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 1) {
          o = oN;
        }
      ...
      if (bh & 1) {
        o = (double*) ((uintptr_t) o + oN_stride);
        _mm_storel_pd((double*) o, (_mm256_castpd256_pd128(v0_3)));
        double *oN = (double*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 3) {
          o = oN;
        }
        _mm_storel_pd((double*) o, (_mm256_castpd256_pd128(v0_2)));
        oN = (double*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width >= 3) {
          o = oN;
        }
        _mm_storel_pd((double*) o, (_mm256_castpd256_pd128(v0_1)));
        oN = (double*) ((uintptr_t) o + minus_output_stride);
        if XNN_UNPREDICTABLE(block_width > 1) {
          o = oN;
        }
